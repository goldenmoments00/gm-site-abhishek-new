...
const NAV_ITEMS = [
  ...
  { label: "Map", href: "/coverage-map", icon: MapPin },
          ...
          <div className="hidden items-center gap-2 md:flex">
            ...
            <motion.div
              animate={{ 
                ...
                boxShadow: [
                  ...
                  "0px 0px 15px 2px rgba(26, 26, 26, 0.5)", 
                  "0px 0px 0px 0px rgba(26, 26, 26, 0)"
                ] 
              }}
            ...
            >
              <Link
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full bg-[#1a1a1a] text-white transition-transform"
              >
